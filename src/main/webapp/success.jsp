...
<body>
  ...
  <image href="img/check.png" width="48" height="48" />
			...
			<h1 style="font-weight: bold; color: #20bf55;">Đăng ký thành
				công</h1>
			<p class="col-lg-6 mx-auto mb-4">
				<h4>Chúc mừng bạn đăng ký thành công tài khoản tại <span style="font-weight: bold; color: orange;">Food Store</span><br> 
			...
			<a class="btn custom-button-style"
				...
				href="login.jsp">Đi tới Đăng Nhập</a>
		</div>
	</div>
	<script>
		setTimeout(function() {
